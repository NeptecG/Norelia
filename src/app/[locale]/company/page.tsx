        ...
        <div className="max-w-[760px]">
          ...
          <dl className="border-t border-border-subtle">
            {rows.map(([label, value]) => (
              <div
                key={label}
                className="grid grid-cols-1 sm:grid-cols-[220px_1fr] gap-1.5 sm:gap-8 py-6 border-b border-border-subtle"
              >
                <dt className="font-body text-[10px] tracking-[0.22em] uppercase text-on-surface/45 pt-0.5">{label}</dt>
